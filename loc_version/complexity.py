"""
Code Complexity Scoring ΓÇö AST Node Complexity + Cyclomatic Complexity
...
def combined_complexity_score(code: str) -> dict:
    ...
    The score is an absolute number (not normalized) ΓÇö lower is simpler.
    """
    import re
...
def format_complexity_report(complexity: dict) -> str:
    ...
    lines.append(f"  ΓòöΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòù")
    lines.append(f"  Γòæ  Combined Score: {complexity['combined_score']:>8.1f}          Γòæ")
    lines.append(f"  ΓòÜΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓò¥")
    return "\n".join(lines)
